...
class Coordinate
{
	...
	public:
		...
		*/
		...
		inline static std::vector<SDL_Rect> pac_l{{47,89,14,15},{63,65,}};
		inline static std::vector<SDL_Rect> pac_d{{75,89,16,16}};
		inline static std::vector<SDL_Rect> pac_u{{109,89,16,16}};
